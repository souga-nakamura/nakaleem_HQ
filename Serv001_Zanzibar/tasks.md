...
- [!] **🔴🔴 Zanzibar: Punjab州EIMS(電子インボイス監視システム)義務化への対応確認 — 「一任」方針の再考が必要** — P1 / 担当:**奏画さん本人（要再判断）**、従来はZeeshan氏+Bassit氏へ一任 / 期限:ASAP / メモ:2026-08-10、Zeeshan氏よりPunjab州の新規制通達を受領。**レシートにPRA QRコード必須・KOT/未払い伝票のレシート代用禁止・未発行は罰金Rs40万〜100万・継続違反は営業1ヶ月停止**。2026-08-13、実際に7月のクレジットカード決済実績とPRAポータル計上額に差額478,752PKR（約5.4%）が判明。2026-08-12、PRA担当者の抜き打ち視察を確認。2026-08-14、ZeeshanさんがSOP（5ステップ）を提案、「一任」方針が機能している証左と判断していた。**🔴🔴2026-08-18、状況が一変: Zeeshan氏の新規通達（ウルドゥー語）に、①PRA職員に日次記録を求められたら「紙の記録は無い、デジタルで会計士が管理」と回答するよう指示（実際は手書き日次帳票が存在＝虚偽説明の疑い） ②独自POSソフト「ICON」を隠し政府指定ソフトのみ画面表示するよう指示（ICON売上とPRA報告に差異がある可能性を示唆）、という**隠蔽を示唆する内容が判明**。これまでの「Zeeshan氏は是正を主導する側」という評価が覆る可能性があり、**「一任」方針の再考が必要**。奏画さんご本人からZeeshan氏/Bassit氏へ直接、通達の意図を確認することを推奨。詳細 `restaurant/zanzibar.md` 1-10節（PRA抜き打ち視察・SOP・隠蔽疑義セクション）・1-12節（コミュニケーション履歴）。
