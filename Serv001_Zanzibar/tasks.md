...
- [ ] **🆕 ランチ専用メニューの開発** — P2 / 担当:Furva+一郎 / 期限:**既存メニュー棚卸し完了後**（2026-08-19確定） / メモ:"Lunch-only menu development"（2026-08-19奏画さん追加）。上記「新規ランチメニューの検討」を具体化＝ランチタイム専用の独立メニューとして開発する方針。詳細 `restaurant/zanzibar.md` 1-13節B。
- [ ] **🆕 インフルエンサー向けアンボックスギフト＋クーポン配布施策** — P2 / 担当:一郎（ドラフト）+奏画 / 期限:**1ヶ月以内**（2026-08-19確定） / メモ:"Unbox gift for influencers, coupon distribution (e.g. free fried rice)"（2026-08-19奏画さん追加）。マーケ/ブランディング施策と関連する新規手法。実施前にaikoへ軽くリスクチェック推奨（無償ギフト・景表法/現地法制の観点）。詳細 `restaurant/zanzibar.md` 1-13節F。
